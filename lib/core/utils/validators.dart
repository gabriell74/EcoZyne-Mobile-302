class Validators {
  ...
  static String? email(String? value) {
    if (value == null || value.isEmpty)
      return requiredField(fieldName: "Email");
  ...
  static String? password(String? value) {
    if (value == null || value.isEmpty)
      return requiredField(fieldName: 'Password');
  ...
  static String? username(String? value) {
    if (value == null || value.isEmpty)
      return requiredField(fieldName: 'Nama Pengguna');
  ...
  static String? whatsapp(String? value) {
    if (value == null || value.isEmpty)
      return requiredField(fieldName: 'No Whatsapp');
  ...
  static String? address(String? value) {
    if (value == null || value.isEmpty)
      return requiredField(fieldName: 'Alamat');
    return null;
  }
}
